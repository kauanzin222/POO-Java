...
public class App {
    ...
    public static void main(String[] args) {
        ...
        FuncionarioHorista funcHor = new FuncionarioHorista(1010, "Pedro Silveira", LocalDate.parse("14/05/1978", fmt1), 15.80);
        ...
        FuncionarioMensalista funcMens = new FuncionarioMensalista(1011, "Maria Antonieta", LocalDate.parse("21/03/1980", fmt1), 7.5);
